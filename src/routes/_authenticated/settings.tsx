...
function SettingsPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Configurações"
        description="Personalize a plataforma e a sua assinatura."
      />
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card className="p-6 space-y-4">
          ...
          <div className="space-y-1.5">
            <Label>Tema</Label>
            <select
              className="w-full h-9 rounded-lg border border-border bg-transparent px-3 text-sm"
        ...
        <Card className="p-6 space-y-4">
          ...
          <p className="text-xs text-muted-foreground">
            Usada em todas as mensagens comerciais como {"{{assinatura}}"}.
          </p>
        </Card>
        ...
        <Card className="p-6 space-y-3 lg:col-span-2">
          ...
          <p className="text-sm text-muted-foreground">
            O cadastro público está desativado. Novos utilizadores devem ser criados pelo admin
            através da consola do backend. O primeiro utilizador registado torna-se automaticamente
            admin.
          </p>
          <div className="text-xs text-muted-foreground">
            Sessão actual: <b>{user.email}</b>
          </div>
        </Card>
      </div>
